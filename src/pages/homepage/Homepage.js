    ...
    <>
      ...
      <div className="header-wrapper">
        <section className="header-content container">
          ...
          <p> 
            At Chateau le roi we provide an exquisite and healthy dining
             experience with for customers of all ages at affordable prices.
      ...
      <section className="menu-content container">
        <div className="menu-content-header">
          ...
          <p>With our wide range of menu items our every meal is an adventure</p>
        </div>

        <div className="menu-categories">
          <ul className="featured-list">
            <li className="list-item active">
              <a href="#!">Kitchen specials</a>
            </li>
